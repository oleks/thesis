...
number of tape cells scanned in a computation. For any halting computation, it
is perhaps natural to consider these two factors as characterising the
``complexity'' of the computation.

\begin{definition} Let $M$ be a deterministic Turing machine that halts an all inputs.
