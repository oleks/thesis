...
this section as \refSec{introduction:internal-references}, read ``section zero,
...
subsequently reference the segment. For instance, \refEx{alice-bob-add}.
...
knowledge outside this thesis. See also \refSec{introduction:audience}.
...
instance, a ``Turing tape'', as discussed in \refSec{background-computability},
...
\refFigure{informal-turing-tape}.
