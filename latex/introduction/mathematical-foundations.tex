...
\todo{Initial algebras, free algebras, and inductive types. Final algebras and
coinductive data types.}

\todo{Due to the lack of a formal treatment of a mathematical foundations for
this document, the exploration of the limits of the present approach, and its
humble mistakes, are left as an exercise for the reader.}
