...
\begin{definition} \label{def:operational-proj} \todo{Not used} Let
...
and many-tiered recursion (and mu measure?).}
...
as in \refDef{operational-comp}, with $S=\mathbb{N}$ and $T=U=\Box\mathbb{N}$.
