...
\begin{remark} $\sem{\mathtt{COMP}}$ is parametric in the types $S$, $T$, and
$U$. \end{remark}
...
The detailed proofs that $\mathcal{L}$ is indeed \FPTIME-sound and
...
Although the original presentation and proofs were in terms of a single-sorted word algebra, as noted in \cite[\textsection 5]{bellantoni-cook-1992}, the results generalise in a straight-forward manner to 
