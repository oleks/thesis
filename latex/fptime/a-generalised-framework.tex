...
\mathbf{S}$.  \index{zero function} \end{definition}
...
$\mathtt{s}\p{n} = n + 1$, for all $n \in \mathbb{N}$. \index{successor
...
the (unique) construction tree as in \refFigure{s-s-z}, having one \emph{zero
