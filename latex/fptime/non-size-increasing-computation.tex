...
% A combinator is a lambda-expression $\lambda x_1 \cdots x_m . X$, where x is
% some combination of $x_1,\ldots, x_m$. Alternatively, it is either an atom,
% or the application of $X$ to $Y$ where $X$ and $Y$ are combinators.
