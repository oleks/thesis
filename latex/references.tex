...
%
Vincent Dornic (CRI), Pierre Jouvelot (CRI), and David K. Gifford (MIT).
\emph{Polymorphic time systems for estimating program complexity}. March 1992.
ACM Letters on Programming Languages and Systems (LOPLAS), Vol 1, No. 1, pp.
33--45.
%
}
...
%
Daniel Leivant (Indiana University). \emph{A Foundational Delineation of
Poly-time}. 1994. Information and Computation, Vol. 110, No. 2, pp. 391--440.
...
complexity classes}.  March 2000.  ACM SIGACT News, Vol. 31, No. 1, pp. 31--42.
...
%
Martin Hofmann (University of Edinburgh). \emph{Safe recursion with higher
types and BCK-algebra}. July 2000. Annals of Pure and Applied Logic Vol. 104,
No. 1--3, pp. 113--166. Published by Elsevier Science B.V.\\
%
\emph{An abridged and updated version of the Habilitation thesis
\cite{hofmann-1999}.}
%
}
...
%
Lars Kristiansen (Oslo University College) and K.H. Niggl (Technische
Universit\"at Ilmenau). \emph{On the computational complexity of imperative
programming languages}. June 2004. Implicit Computational Complexity,
Theoretical Computer Science, Vol. 318, No. 1--2, pp. 139--161. Published by
Elsevier B.V. 
%
}
...
and LINSPACE}. April 2005. computational complexity Vol. 14, No. 1, pp. 72--88.
Published by Birkh\"auser-Verlag Basel.\\
%
\emph{Characterises the complexity classes without either explicit bounds (as
in \cite{cobham-1965}), variable segregation (as in \cite{bellantoni-cook-1992,
leivant-1995}), or complicated initial functions as e.g. the smash function.}
%
}
...
%
Alan Cobham (IBM Research Center). \emph{The intrinsic computational difficulty
of functions}.  1965. In Proceedings of the 1964 International Congress for
Logic, Methodology and Philosophy of Science, pp. 24--30. Edited by Yehoshua
Bar-Hillel. Published by North-Holland Publishing Company in Amsterdam,
Holland.  Printed in Israel, by Jerusalem Academic Press Ltd.
%
}
...
%
Daniel Leivant (Indiana University). \emph{Stratified functional programs and
...
%
Brian Reistad and David K. Gifford (MIT). \emph{ Static dependent costs for
...
by ACM New York. ISBN: 0-89791-643-3.
%
}

\bib{Voda (1994)}{voda-1994}{%
%
Paul J. Voda (University of Bratislava). \emph{Subrecursion as a Basis for a
Feasible Programming Language}. September 1994. In Leszek Pacholski Jerzy
Tiuryn (eds.), \emph{Selected Papers from the 8th International Workshop on
Computer Science Logic} (CSL'94), pp. 324--338.  Published by Springer Verlag
London.  ISBN: 3-540-60017-5.
%
}
...
%
Karl Crary (CMU) and Stephnie Weirich (Cornell). \emph{Resource bound
certification}. January 2000. In Proceedings of the 27th ACM SIGPLAN-SIGACT
symposium on Principles of programming languages (POPL'00), pp.  184--198.
Published by ACM New York. ISBN:1-58113-125-9.
%
}
...
\bib{Hofmann (1999)}{hofmann-1999}{%
%
Martin Hofmann (Unviersit\"at Darmstadt). \emph{Type systems for
polynomial-time computation}. February 1999. Habilitation thesis. Appeared as a
Laboratory for Foundations of Computer Science at the University of Edinburgh
(LFCS) Technical Report ECS-LFCS-99-406. \\
%
\emph{An abridged and updated version appears in \cite{hofmann-2000b}.}
%
}
